...
from app.ai.shared_utils.outline_cleanup import (
...
class FinalizationPhase:
    ...
    def _persist_artifacts(
        ...
        synth._emit_step("Finalizing A0 outputs and generated TO artifacts…")
        ...
        logger.info("[A0] llm_to_outline finalized in-memory for run %s", synth.run_id)
