...
from lectora_backend.pipeline.agent.to_generation_pipeline.step_03_repair_outline.constants.prompts import (
...
class S1ValidatorRefineAgent:
    ...
    def __init__(
        ...
        *,
        ...
        llm_chat_fn: Callable[[str, str, LLMConfig, str], str] | None = None,
